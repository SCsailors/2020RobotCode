...
GoalTracker::TrackReport::TrackReport(GoalTrack track)
{
...
GoalTracker::TrackReportComparator::TrackReportComparator(double stability_weight, double age_weight, double switching_weight, int last_track_id, double current_timestamp)
{
...
double GoalTracker::TrackReportComparator::score(TrackReport report)
{
...
int GoalTracker::TrackReportComparator::compare(TrackReport o1, TrackReport o2)
{
...
std::vector<VisionTargeting::GoalTracker::TrackReport> GoalTracker::getTracks()
{
